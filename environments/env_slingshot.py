class ENV_SLINGSHOT:
    ...
    def Send_To_Simulator(self,positionOffset, drawOffset, fadeStrategy):
        ...
        self.Send_Ball(self.simulator, self.positionOffset + [0, 0, 0], self.drawOffset, self.fadeStrategy)

    # --------------- Private functions -----------------------------------------------------

    def Send_Ball(self, simulator, positionOffset, drawOffset, fadeStrategy):
        x = 3 + positionOffset[0]
        y = 0 + positionOffset[1]
        z = 10 + positionOffset[2]
