...
class ENV_CUBE_GREENANDRED_FRONT:
        ...
        def Send_To_Simulator(self,positionOffset, drawOffset, fadeStrategy):
                ...
                self.Send_Box2(self.simulator, self.positionOffset, self.drawOffset, self.fadeStrategy)

# --------------- Private functions -----------------------------------------------------

        def Send_Box(self,simulator, positionOffset, drawOffset, fadeStrategy):
                x = 0 + positionOffset[0]
                y = 2 + positionOffset[1]
        ...
        def Send_Box2(self,simulator, positionOffset, drawOffset, fadeStrategy):
                x = 0 + positionOffset[0]
                y = 2 + positionOffset[1]
                z = 0.5 + 0.5/2 + positionOffset[2]
