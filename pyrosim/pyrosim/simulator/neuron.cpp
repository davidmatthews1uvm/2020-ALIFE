...
NEURON::NEURON(int myID, int neuronType, double tau, double a, double lastValue, double value){
	Initialize(myID, neuronType, tau, a, lastValue, value);
	if ( type == BIAS_NEURON)
		value = 1.0;
}
...
NEURON::NEURON(int myID, int neuronType, double tau, double a) {
	...
	Initialize(myID, neuronType, tau, a, 0.0, 1.0);
	if ( type == BIAS_NEURON)
		value = 1.0;
}
...
void NEURON::Initialize(int myID, int neuronType, double t, double a){
	Initialize(myID, neuronType, t, a, 0.0, 0.0);
}

void NEURON::Initialize(int myID, int neuronType, double t, double a, double lastValue, double value) {
