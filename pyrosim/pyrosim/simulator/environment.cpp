...
void ENVIRONMENT::Draw(int t, int evalPeriod, int debug) {

        for (int i=0;i<numberOfBodies;i++)

                objects[i]->Draw(t,evalPeriod);
...
void ENVIRONMENT::Create_Hidden_Neuron(void)
{
	...
	neuralNetwork->Add_Hidden_Neuron(ID,tau,alpha, lastValue, value);
}
