...
void NEURAL_NETWORK::Add_Hidden_Neuron(int ID, double tau, double alpha, double lastValue, double value) {
	neurons[numNeurons] = new NEURON(ID,HIDDEN_NEURON,tau, alpha, lastValue, value);
	numNeurons++;
}
