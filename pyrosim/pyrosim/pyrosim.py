...
class Simulator(object):
    ...
    speed       : integer
            The speed of the simulation. 1 = 1x, 2 = 2x, etc.
    """

    WORLD = -1
    FOREVER = -1

    def __init__(self, silent_mode=False, play_blind=False, play_paused=False,
                 eval_time=evaluation_time, dt=dt,
                 gravity=gravity,
                 window_size=(750, 500),
                 xyz=xyz, hpr=hpr, use_textures=False,
                 debug=False, capture=0,speed=speed):
    ...
    def send_box(self, x=0, y=0, z=0, mass=1.0,
                 ...
                 draw_offset_x=0, draw_offset_y=0, draw_offset_z=0,
        ...
        draw_offset: float , optional
		Draw the box (possibly) somewhere else. 
	...
	fadeStrategy:
		How or whether this object will fade during simulation.
    ...
    def send_cylinder(self,
        ...
        draw_offset : float, optional
		The offset as to where the object should be drawn.
        r       : float, optional
        collision_group : str or int, optional
                The collision group the body is assigned to. The collision
                group determines how the body collides with other bodies.
        ...
        b       : float, optional
                The amount of the color blue in the body (b in [0,1])
        fadeStrategy: int, optional
                How and whether the object should fade during simulation.
    ...
    def send_hidden_neuron(self, tau=1.0, alpha=1.0, last_value = 0, value = 0):
        ...
        self._send('HiddenNeuron', neuron_id, tau, alpha, last_value, value)
	...
	draw_offset : float, optional
		Draw the ray sensor somewhere else.
        r1       : float, optional
    ...
    def get_simulation_string(self):
        """
        returns the string to send to the physics engine to run the evaluation
        :return: String
        """
        to_send = self.strings_to_send
        to_send.append("Done\n")
        return ''.join(to_send)
